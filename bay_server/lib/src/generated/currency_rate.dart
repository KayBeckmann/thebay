...
abstract class CurrencyRate
  ...
  static CurrencyRateInclude include() {
    return CurrencyRateInclude._();
  }
...
class CurrencyRateTable extends _i1.Table<int?> {
  CurrencyRateTable({super.tableRelation})
      : super(tableName: 'currency_rates') {
    baseCurrency = _i1.ColumnString(
      'baseCurrency',
      this,
    );
    targetCurrency = _i1.ColumnString(
      'targetCurrency',
      this,
    );
  ...
  /// Base currency (e.g., 'USD', 'EUR')
  late final _i1.ColumnString baseCurrency;

  /// Target currency (e.g., 'BTC', 'USD')
  late final _i1.ColumnString targetCurrency;
