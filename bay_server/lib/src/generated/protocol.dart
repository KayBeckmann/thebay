...
import 'registration_request.dart' as _i10;
import 'settings.dart' as _i11;
import 'slot_variant.dart' as _i12;
import 'user.dart' as _i13;
import 'user_role.dart' as _i14;
import 'package:bay_server/src/generated/category.dart' as _i15;
import 'package:bay_server/src/generated/news.dart' as _i16;
import 'package:bay_server/src/generated/slot_variant.dart' as _i17;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i10.RegistrationRequest) {
      return _i10.RegistrationRequest.fromJson(data) as T;
    }
    if (t == _i11.Settings) {
      return _i11.Settings.fromJson(data) as T;
    }
    if (t == _i12.SlotVariant) {
      return _i12.SlotVariant.fromJson(data) as T;
    }
    if (t == _i13.User) {
    ...
    if (t == _i1.getType<_i10.RegistrationRequest?>()) {
      return (data != null ? _i10.RegistrationRequest.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i11.Settings?>()) {
      return (data != null ? _i11.Settings.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.SlotVariant?>()) {
      return (data != null ? _i12.SlotVariant.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i16.News>) {
      return (data as List).map((e) => deserialize<_i16.News>(e)).toList() as T;
    }
    ...
    if (t == List<_i17.SlotVariant>) {
      return (data as List)
          .map((e) => deserialize<_i17.SlotVariant>(e))
          .toList() as T;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i10.RegistrationRequest) {
      return 'RegistrationRequest';
    }
    if (data is _i11.Settings) {
      return 'Settings';
    }
    if (data is _i12.SlotVariant) {
      return 'SlotVariant';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'RegistrationRequest') {
      return deserialize<_i10.RegistrationRequest>(data['data']);
    }
    if (dataClassName == 'Settings') {
      return deserialize<_i11.Settings>(data['data']);
    }
    if (dataClassName == 'SlotVariant') {
      return deserialize<_i12.SlotVariant>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i12.SlotVariant:
        return _i12.SlotVariant.t;
      case _i13.User:
        return _i13.User.t;
    }
    return null;
