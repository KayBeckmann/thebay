...
--
-- Class UserBanLog as table user_ban_log
--
...
--
-- Foreign relations for "user_ban_log" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('bay', '20251223194755707', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251223194755707', "timestamp" = now();
